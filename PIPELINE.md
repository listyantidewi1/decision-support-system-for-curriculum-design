...
| Plot | Purpose |
|------|---------|
| `skills_knowledge_total_per_model.png` | Total skills & knowledge by JobBERT/GPT/Hybrid |
...
| `evaluate_extraction.py` | Precision/recall/F1 per extractor (BERT/GPT/Hybrid) |
