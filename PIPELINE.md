...
| 3 | `plot_generator.py` | model_comparison, coverage_report, etc. | Plots in results/ |
...
| 10 | `evaluate_extraction.py` | DATA/labels/gold_*.csv | extraction_evaluation_report.json |
| 11 | `evaluate_future_mapping.py` | gold_future_domain.csv, future_skill_weights.csv | future_mapping_evaluation_report.json |
| 12 | `log_run_metadata.py` | config, dataset | run_metadata.json (updated) |
...
*Last updated: Scientific rigor upgrade — gold set, calibration, FDR trends, real forecasts, recommendations, reproducibility.*
