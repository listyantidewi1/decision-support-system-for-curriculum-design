...
WEF_DOMAINS = [
    ...
    {"domain_id": "WEF03", "future_domain": "Cybersecurity",
     "example_terms": "cybersecurity, information security, penetration testing, threat intelligence, zero trust, SOC, incident response, encryption, vulnerability assessment, SIEM, firewall, malware analysis, compliance audit, security operations",
     "trend_label": "Strong_Growth", "trend_score": 0.9, "source": "WEF_FutureOfJobs_2023", "horizon_year": 2030},
    ...
    {"domain_id": "WEF06", "future_domain": "Environmental & Sustainability Technology",
     "example_terms": "green technology, sustainable computing, energy efficiency, smart grids, environmental monitoring, carbon footprint, renewable energy, circular economy, ESG metrics, lifecycle assessment, clean tech",
    ...
    {"domain_id": "WEF07", "future_domain": "Human-AI Collaboration",
     "example_terms": "prompt engineering, AI-assisted coding, copilot, human-in-the-loop, explainable AI, AI ethics, responsible AI, augmented intelligence, decision support, AI governance, collaborative automation",
